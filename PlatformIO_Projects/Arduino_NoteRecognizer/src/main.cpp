...
// #define MICROPHONE_ANALOG_IN 5
// #define MICROPHONE_DIGITAL_IN 7
...
//   pinMode(MICROPHONE_DIGITAL_IN, INPUT);
...
//   int sensorValue = analogRead(MICROPHONE_ANALOG_IN);
...
{
  Serial.begin(9600);
  Mic_pin = A5; // change as per Microphone   pin
}
